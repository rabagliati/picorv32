...
set_property PACKAGE_PIN K5 [get_ports rgb0[0]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb0[0]]
##Bank = 15, Pin name = IO_L5P_T0_AD9P_15,					Sch name = LED16_G
set_property PACKAGE_PIN F13 [get_ports rgb0[1]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb0[1]]
##Bank = 35, Pin name = IO_L19N_T3_VREF_35,					Sch name = LED16_B
set_property PACKAGE_PIN F6 [get_ports rgb0[2]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb0[2]]
##Bank = 34, Pin name = IO_0_34,						Sch name = LED17_R
set_property PACKAGE_PIN K6 [get_ports rgb1[0]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb1[0]]
##Bank = 35, Pin name = IO_24P_T3_35,						Sch name =  LED17_G
set_property PACKAGE_PIN H6 [get_ports rgb1[1]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb1[1]]
##Bank = CONFIG, Pin name = IO_L3N_T0_DQS_EMCCLK_14,			Sch name = LED17_B
set_property PACKAGE_PIN L16 [get_ports rgb1[2]]
set_property IOSTANDARD LVCMOS33 [get_ports rgb1[2]]

## 
##7 segment display
##Bank = 34, Pin name = IO_L2N_T0_34,						Sch name = CA
set_property PACKAGE_PIN L3 [get_ports {seg7A}]
set_property IOSTANDARD LVCMOS33 [get_ports {seg7A}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {seg7B}]
set_property IOSTANDARD LVCMOS33 [get_ports {seg7B}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {seg7C}]
set_property IOSTANDARD LVCMOS33 [get_ports {seg7C}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {seg7D}]
set_property IOSTANDARD LVCMOS33 [get_ports {seg7D}]
##Bank = 34, Pin name = IO_L2P_T0_34,						Sch name = CE
set_property PACKAGE_PIN K3 [get_ports {seg7E}]
set_property IOSTANDARD LVCMOS33 [get_ports {seg7E}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {seg7F}]
set_property IOSTANDARD LVCMOS33 [get_ports {seg7F}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {seg7G}]
set_property IOSTANDARD LVCMOS33 [get_ports {seg7G}]
...
set_property PACKAGE_PIN B13 [get_ports {monitor[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[0]}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,				Sch name = JA2
set_property PACKAGE_PIN F14 [get_ports {monitor[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[1]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,				Sch name = JA3
set_property PACKAGE_PIN D17 [get_ports {monitor[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[2]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,				Sch name = JA4
set_property PACKAGE_PIN E17 [get_ports {monitor[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[3]}]
##Bank = 15, Pin name = IO_0_15,					Sch name = JA7
set_property PACKAGE_PIN G13 [get_ports {monitor[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[4]}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,				Sch name = JA8
set_property PACKAGE_PIN C17 [get_ports {monitor[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[5]}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,				Sch name = JA9
set_property PACKAGE_PIN D18 [get_ports {monitor[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[6]}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,				Sch name = JA10
set_property PACKAGE_PIN E18 [get_ports {monitor[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[7]}]



##Pmod Header JB
##Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,			Sch name = JB1
set_property PACKAGE_PIN G14 [get_ports {monitor[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[8]}]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,				Sch name = JB2
set_property PACKAGE_PIN P15 [get_ports {monitor[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[9]}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = JB3
set_property PACKAGE_PIN V11 [get_ports {monitor[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[10]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,			Sch name = JB4
set_property PACKAGE_PIN V15 [get_ports {monitor[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[11]}]
##Bank = 15, Pin name = IO_25_15,					Sch name = JB7
set_property PACKAGE_PIN K16 [get_ports {monitor[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[12]}]
##Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = JB8
set_property PACKAGE_PIN R16 [get_ports {monitor[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[13]}]
##Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = JB9
set_property PACKAGE_PIN T9 [get_ports {monitor[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[14]}]
##Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = JB10 
set_property PACKAGE_PIN U11 [get_ports {monitor[15]}]
set_property IOSTANDARD LVCMOS33 [get_ports {monitor[15]}]
 

## 
## ##Pmod Header JC
## ##Bank = 35, Pin name = IO_L23P_T3_35,						Sch name = JC1
set_property PACKAGE_PIN K2 [get_ports {nstep}]
set_property IOSTANDARD LVCMOS33 [get_ports {nstep}]
## ##Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
## set_property PACKAGE_PIN E7 [get_ports {spi0_miso}]
## set_property IOSTANDARD LVCMOS33 [get_ports {spi0_miso}]
## ##Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
## set_property PACKAGE_PIN J3 [get_ports {spi0_clk}]
## set_property IOSTANDARD LVCMOS33 [get_ports {spi0_clk}]
## ##Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
## set_property PACKAGE_PIN J4 [get_ports {spi0_cs0n}]
## set_property IOSTANDARD LVCMOS33 [get_ports {spi0_cs0n}]
## ##Bank = 35, Pin name = IO_L23N_T3_35,						Sch name = JC7
## #set_property PACKAGE_PIN K1 [get_ports {spi0_cs1n}]
## #set_property IOSTANDARD LVCMOS33 [get_ports {spi0_cs1n}]
## ##Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
## set_property PACKAGE_PIN E6 [get_ports {spi0_cs1n}]
## set_property IOSTANDARD LVCMOS33 [get_ports {spi0_cs1n}]
## ##Bank = 35, Pin name = IO_L22N_T3_35,						Sch name = JC9
## set_property PACKAGE_PIN J2 [get_ports {spi0_mosi}]
## set_property IOSTANDARD LVCMOS33 [get_ports {spi0_mosi}]
## ##Bank = 35, Pin name = IO_L19P_T3_35,						Sch name = JC10
## set_property PACKAGE_PIN G6 [get_ports {j1_busy}]
## set_property IOSTANDARD LVCMOS33 [get_ports {j1_busy}]
## 
##  
## ##Pmod Header JD
...
## #set_property PULLUP TRUE [get_ports {nstep}]
...
## set_property PACKAGE_PIN L13 [get_ports spi1_cs0n]
## set_property IOSTANDARD LVCMOS33 [get_ports spi1_cs0n]
## 
## 
## 
## ##Cellular RAM
